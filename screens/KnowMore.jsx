    ...
    return (
        ...
        >
            ...
            <View style={[flex.f_1]}>
                ...
                >
                    <View style={[justify.end, align.items_center]} key="1">
                        <Image
                            source={Card3}
                    ...
                    <View style={[justify.end, align.items_center]} key="2">
                        <Image
                            source={Card1}
                    ...
                    <View style={[justify.end, align.items_center]} key="3">
                        <Image
                            source={Card2}
            ...
            <View style={[align.self_center, m.mb_24]}>
                <TouchableOpacity style={[bdr.w_2, bdr.color_("#314623"), p.px_6, p.py_2, bdr.rounded_full]} onPress={() => navigation.navigate("KnowMore")}>
                    <Text style={[text.fs_2xl, text.fw_black, text.color_("#A3E635")]}>Get Started</Text>
                </TouchableOpacity>
            </View>
            <Image
